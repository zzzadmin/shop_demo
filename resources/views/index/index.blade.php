			...
			<div class="row margin-bottom">
				<div class="col s6">
					<div class="content">
						...
						<button class="btn button-default"><a href="{{url('/home/buy')}}?id={{$v->id}}">购买</a></button>
					</div>
				</div>
				<div class="col s6">
					<div class="content">
						...
						<button class="btn button-default"><a href="{{url('/home/buy')}}?id={{$v->id}}">ADD TO CART</a></button>
					</div>
				</div>
			</div>
			@endforeach
